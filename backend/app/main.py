...
from .api.v1 import auth, plans, analysis, stages, resources, methods, progress, vip, admin_auth, dashboard, kanban
...
app.include_router(kanban.router, prefix=api_prefix)
